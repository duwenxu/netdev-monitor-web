<template>
  <div>
    ...
    <node-chart @on-click="clickNode" :base-data="baseData" :grid="grid" :nodes="nodes"
                :mark-point="markPoint" :dottedLines="dottedLines" :poly-no-effect="inverterLines"
                :poly-lines="polyLines" :straight-lines="linesData"></node-chart>
...
export default {
  components: {nodeChart, DeviceMain},
  mixins: [mixin],
  data() {
    return {
      shineData: [],
