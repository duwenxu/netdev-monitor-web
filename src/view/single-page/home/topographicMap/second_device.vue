<template>
  ...
  <div style="padding-top:20px">
    ...
    <node-chart :base-data="baseData" @on-click="clickNode" :nodes="nodes"
                :poly-lines="polyData" :single-arrow-lines="transPolyMachineLines"
                :arrow-lines="transMachineLine" :poly-no-effect="deviceLines" :straight-lines="lines"
                :mark-point="markPoint" :grid="grid" style="margin-top: -15px"></node-chart>
...
export default {
  ...
  methods: {
    ...
    clickNode(data) {
      if (data) {
        let obj = {devNo: data, value: false}
        this.commonClickNode(obj)
      }
    },
    openParam(info) {
      if (info.devNo) {
