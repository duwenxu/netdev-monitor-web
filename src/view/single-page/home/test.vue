  ...
  methods: {
    ...
    devicePosition(equipment) {
      return {
        ...
        marginmarginLeft: this.position[equipment.devNo].marginLeft
      }
    },
    masterStatus(equipment) {
      if (equipment.devNo != 20) {
        return {
          ...
          marginmarginLeft: this.masterPosition[equipment.devNo].marginLeft,
...
//---------------工作舱
      ...
      var option = {
        animation: false,
        grid: {marginLeft: '10', bottom: '15', top: '5', right: '5'},
        xAxis: {
          min: 0,
          max: 830,
          show: false,
