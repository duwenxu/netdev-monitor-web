  ...
  methods: {
    ...
    commonFunc(v) {
      ...
      let data = [{
        ...
        "paraViewFmt": "",
        "parahowMode": "0024002",
        "spinnerInfoList": [{"code": "00", "name": "未锁定"}, {"code": "01", "name": "锁定"}],
        "subParaLinkCode": "",
        "subParaLinkType": "",
        "subParaLinkVal": "",
        "subParaList": []
        ...
        "paraViewFmt": "",
        "parahowMode": "0024001",
        "spinnerInfoList": [{"code": "0", "name": "错误"}, {"code": "1", "name": "成功"}],
        "subParaLinkCode": "",
        "subParaLinkType": "",
        "subParaLinkVal": "",
        "subParaList": []
        ...
        "paraViewFmt": "",
        "parahowMode": "0024002",
        "spinnerInfoList": [{"code": "01", "name": "帧头错误"}, {"code": "02", "name": "帧ID错误"}, {
          "code": "03",
          "name": "校验和错误"
        }, {"code": "04", "name": "帧长度错误"}, {"code": "FF", "name": "其他错误"}],
        "subParaLinkCode": "",
        "subParaLinkType": "",
        "subParaLinkVal": "",
        "subParaList": []
